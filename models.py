...
class Customercustomerdemo(models.Model):
    customerid = models.ForeignKey('Customers', db_column='CustomerID')  # Field name made lowercase.
    customertypeid = models.ForeignKey('Customerdemographics', db_column='CustomerTypeID')  # Field name made lowercase.
...
class Employeeterritories(models.Model):
    employeeid = models.ForeignKey(Employees, db_column='EmployeeID')  # Field name made lowercase.
    territoryid = models.ForeignKey('Territories', db_column='TerritoryID')  # Field name made lowercase.
